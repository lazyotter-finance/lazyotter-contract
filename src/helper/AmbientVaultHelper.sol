...
contract AmbientVaultHelper is ReentrancyGuard {
    ...
    function previewAmountByAsset(
        ...
        uint128 liquidity = _safeConvertUint256ToUint128(assets);
    ...
    function redeem(
        ...
        bytes memory returnMsg = _removeLiquidity(poolInfo, _safeConvertUint256ToUint128(liquidity), limitPrice, vault);
    ...
    function withdraw(
        ...
        bytes memory returnMsg = _removeLiquidity(
            ...
            _safeConvertUint256ToUint128(assets),
            limitPrice,
            vault
        );
    ...
    function withdrawSingle(
        ...
        uint256 liquidity = IVault(vault).withdraw(assets, address(this), msg.sender);
